...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
    ...
    return(
        <div className="md:w-1/2 lg:w-2/5">
            <h2 className="font-black text-3xl text-center">Seguimiento de Paciente</h2>
            ...
            <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 mx-5" onSubmit={handleSubmit}>
                ...
                {/* <div className="mb-5">
                    <label htmlFor="telefono" className="block text-gray-700 font-bold uppercase">Telefono</label>
                    <input 
                        id="telefono"
                        type="tel"
